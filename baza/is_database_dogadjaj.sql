...
CREATE TABLE `dogadjaj` (
  ...
  `ImaAlarm` tinyint(1) NOT NULL DEFAULT '0',
  `IDAlarm` int(11) DEFAULT NULL,
  PRIMARY KEY (`IDDogadjaj`),
  KEY `IDAlarm` (`IDAlarm`),
  CONSTRAINT `idalarm_fk1` FOREIGN KEY (`IDAlarm`) REFERENCES `alarm` (`IDAlarm`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2019-07-04 12:08:36
